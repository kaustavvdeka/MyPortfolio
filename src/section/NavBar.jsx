  ...
  return (
    ...
    >
      <div className="mx-auto c-space max-w-7xl">
        <div className="relative flex items-center justify-between px-5 py-2.5 rounded-2xl backdrop-blur-2xl bg-[#030412]/80 border border-white/10 shadow-[0_15px_35px_rgba(0,0,0,0.6),0_0_20px_rgba(56,189,248,0.08)]">
          ...
          >
            ...
            <div className="relative flex items-center justify-center w-8 h-8 rounded-xl bg-gradient-to-br from-cyan-500/25 to-purple-600/25 border border-cyan-400/50 shadow-[0_0_12px_rgba(56,189,248,0.35)] group-hover:border-cyan-300 transition-colors">
              <span className="font-extrabold text-xs text-cyan-300 tracking-wider">K</span>
              <span className="absolute -top-1 -right-1 w-2 h-2 rounded-full bg-cyan-400 shadow-[0_0_8px_#38bdf8] animate-pulse" />
            </div>

            <span className="font-bold text-base lg:text-lg tracking-wide bg-gradient-to-r from-white via-neutral-200 to-neutral-400 bg-clip-text text-transparent group-hover:from-cyan-300 group-hover:to-purple-400 transition-all duration-300">
              Kaustav Mani Deka
            </span>
          </motion.a>
          ...
          {/* 3D CTA "Let's Talk" Button with luxury cosmic theme */}
          ...
          {/* Mobile Menu Button with 3D Rotation */}
          <motion.button
            onClick={() => setIsOpen(!isOpen)}
            whileTap={{ scale: 0.9, rotate: 90 }}
            className="flex md:hidden p-2 rounded-xl bg-white/5 hover:bg-white/10 border border-white/10 transition-colors text-white"
              ...
              <ul className="flex flex-col space-y-2">
                ...
                >
                  <a
                    ...
                    className="block text-center py-2.5 rounded-xl bg-gradient-to-r from-cyan-500/25 via-indigo-500/30 to-purple-500/25 border border-cyan-400/50 text-white font-bold text-xs shadow-lg shadow-cyan-500/20"
                  >
                    Let's Talk
                  </a>
                </motion.li>
